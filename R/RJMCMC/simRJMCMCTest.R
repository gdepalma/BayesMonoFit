...
library(ggplot2)
library(reshape2)
setwd('/media/glen/USB20FD/Research Projects/SimRJMCMC/')
source(paste(getwd(),'/ModelFunctions.R',sep=''))
source(paste(getwd(),'/knotSelectionFunction.R',sep=''))
source(paste(getwd(),'/splineFit.r',sep=''))
source(paste(getwd(),'/splineFunctions.R',sep=''))
source(paste(getwd(),'/simRJMCMC.R',sep=''))
source(paste(getwd(),'/knotSelectionFunction.R',sep=''))
dyn.load(paste(getwd(),'/splineFunctionsC.so',sep=''))
dyn.load(paste(getwd(),'/modelBrkptC.so',sep=''))
dyn.load(paste(getwd(),'/DP.so',sep=''))
